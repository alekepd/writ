...
class RotateToSVDFrame(Iterable[A]):
    ...
    def _rotate(self, coords_batch: ArrayMxNx3, forces_batch: ArrayMxNx3) -> Tuple[ArrayMxNx3, ArrayMxNx3]:
        rotated_coords = []
        rotated_forces = []
        ...
        return np.concatenate(rotated_coords, axis=0), np.concatenate(rotated_forces, axis=0)

    def _rotate_single_frame(self, coords: ArrayNx3, forces: ArrayNx3) -> Tuple[ArrayNx3, ArrayNx3]:
    ...
    def __iter__(self) -> Iterator[A]:
        ...
        for pull in self.source:
            ...
            coords_batch_rot, forces_batch_rot = self._rotate(coords_batch=coords_batch,
